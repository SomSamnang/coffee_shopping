...
.card-header { font-size: 1.6rem; font-weight: 700; text-align: center; color: #6c63ff; margin-bottom: 15px; }

.staff-id-info { text-align: center; font-weight: 500; margin-bottom: 20px; color: #333; }

.form-label { font-size: 0.9rem; font-weight: 500; color: #555; }
.form-uniform { height: 45px; padding: 6px 14px; font-size: 0.9rem; border-radius: 12px; border: 1px solid #ddd; box-sizing: border-box; transition: 0.3s; }
.form-uniform:focus { border-color: #6c63ff; box-shadow: 0 0 10px rgba(108,99,255,0.2); }

.photo-preview { width: 70px; height: 70px; border-radius: 50%; object-fit: cover; border: 3px solid #ddd; display: block; margin: 0 auto 20px auto; transition: transform 0.3s, box-shadow 0.3s; }
.photo-preview:hover { transform: scale(1.1); box-shadow: 0 0 15px rgba(108,99,255,0.3); }

.btn-primary, .btn-success { width: 100%; padding: 12px; border-radius: 12px; font-size: 1rem; font-weight: 600; transition: 0.3s; }
.btn-success:hover { background: #28a745; transform: translateY(-2px); }
.btn-secondary { width: 100%; padding: 12px; border-radius: 12px; font-size: 0.95rem; margin-top: 10px; }

/* Loading Overlay */
#loadingOverlay { position: fixed; top:0; left:0; width: 100%; height: 100%; background: rgba(0,0,0,0.6); display: none; align-items: center; justify-content: center; z-index: 9999; flex-direction: column; color: #001affff; font-size: 1.2rem; }
