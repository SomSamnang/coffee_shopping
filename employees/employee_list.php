...
// Store the result into an array for safe reuse (table + cards)
$employees = [];
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end"> 
                    ...
                    <?php if($role==='admin'): ?> 
                    <li><a class="dropdown-item" href="../users/user_list.php">
                        <i class="bi bi-people-fill me-2 text-danger"></i>Users</a></li> 
                    <li><a class="dropdown-item" href="../home/index.php">
                        <i class="bi bi-house-door me-2 text-info"></i>Home</a></li> 
                    <?php endif; ?> 
