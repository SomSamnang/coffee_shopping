...
<div class="d-flex align-items-center gap-2 flex-wrap">
    ...
    <?php if($currentUser): ?>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-bs-toggle="dropdown">
                <i class="bi bi-person-circle text-warning me-1"></i><?= htmlspecialchars($currentUser) ?>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item text-primary" href="profile.php"><i class="bi bi-person me-2"></i>Profile</a></li>
                <li><a class="dropdown-item text-primary" href="category_list.php"><i class="bi bi-list-ul me-2"></i>Category</a></li>
                <li><a class="dropdown-item text-primary" href="index.php"><i class="bi bi-house-door me-2"></i>Home</a></li>
                <?php if($role === 'admin'): ?>
                <li><a class="dropdown-item text-success" href="user_list.php"><i class="bi bi-people-fill me-2"></i>Users</a></li>
                <?php endif; ?>
    ...
    <?php else: ?>
        <li class="nav-item"><a class="nav-link btn btn-outline-light btn-sm text-primary" href="login.php"><i class="bi bi-box-arrow-in-right me-2 text-success"></i>Login</a></li>
    <?php endif; ?>
    </ul>
</div>
</header>
...
<div class="card-body">
    ...
    <div class="d-flex gap-2 mb-3">
        <a href="add_product.php" class="btn btn-primary btn-sm"><i class="bi bi-plus-circle me-1"></i> Add Product</a>
    </div>
