...
<script>
let sec=3; setInterval(()=>{sec--;document.getElementById('count').textContent=sec;if(sec<=0) location.href='product.php';},1000);
</script>
<?php else: ?>
...
<div class="d-flex gap-2"><button class="btn btn-primary flex-fill">Update</button><a href="product.php" class="btn btn-secondary flex-fill">Cancel</a></div>
</form>
<?php endif; ?>
</div>
