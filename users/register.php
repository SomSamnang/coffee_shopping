...
<div class="card-register">
    ...
    <form method="POST" id="registerForm">
        ...
        <a href="../users/user_list.php" class="btn w-100 mb-3" style="background: linear-gradient(90deg,yellow,green); color:#fff;">
...
<?php if ($success): ?>
overlay.style.display = "flex";
setTimeout(() => { window.location.href = "../users/user_list.php"; }, 1000);
<?php endif; ?>
